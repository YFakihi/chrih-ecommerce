      ...
      <div class="absolute inset-0 overflow-hidden">
        <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
          <div class="pointer-events-auto w-screen max-w-md transform transition ease-in-out duration-500 sm:duration-700 translate-x-full" data-element="shopping-cart">
            <div class="flex h-full flex-col overflow-y-scroll bg-[#1F2937] shadow-xl">
              <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                <div class="flex items-start justify-between">
                  <h2 class="text-lg font-medium text-slate-50" id="slide-over-title">Shopping cart</h2>
              ...
              <div class="border-t border-gray-700 px-4 py-6 sm:px-6">
                <div class="flex justify-between text-base font-medium text-slate-50">
                  <p>Subtotal</p>
                  <p data-total>$0</p>
                </div>
                ...
                <div class="mt-6">
                  ...
                  <button class="flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-6 py-3 text-base font-medium text-slate-50 shadow-sm hover:bg-blue-600 w-full" id="checkout-button">Checkout</button>
                </div>
